...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Roboto', sans-serif;color:#fff !important">
    ...
    <div class="navbar" style="display: grid;width: 85vw;height:4vw;color:#042A38;position:fixed;border-radius:10rem;margin-top:4vh;margin-left:6vw;">
        ...
        <section class="dash" style="margin-top:6.5vw">
            <section id="ans">
                <center>
                    <form style="margin: 0vw;width: 100vw" method="post">

                        <label for="quizname" style="font-size: 2.5vw;">Add Questions</label><br><br>
                        <div id="QS">
                        ...
                        <input type="submit" name="submit" value="add 1 more question" class="submit_btn" >
                        <input type="submit" name="submit1" value="Done" class="submit_btn">
                    </form>
                </center>
            </section>
        </section>
